const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Cost Allocation' }],
  tableOfContents: [
  ...
  formulaDescription: 'Allocate shared costs to departments based on headcount, square footage, or usage.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Allocate shared costs to departments based on headcount, square footage, or usage.' },
