const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Expected Hours (PERT)' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate project estimate using three-point estimation (PERT): best, likely, worst case. See expected hours and cost.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate project estimate using three-point estimation (PERT): best, likely, worst case. See expected hours and cost.' },
