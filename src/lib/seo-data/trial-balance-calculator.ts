const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Trial Balance Status' }],
  tableOfContents: [
  ...
  formulaDescription: 'Verify total debits equal total credits in the trial balance. Identify unbalanced entries.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Verify total debits equal total credits in the trial balance. Identify unbalanced entries.' },
