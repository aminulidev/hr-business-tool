const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Required Billable Rate' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate required billable rate from target salary, overhead multiplier, utilization rate, and profit margin.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate required billable rate from target salary, overhead multiplier, utilization rate, and profit margin.' },
