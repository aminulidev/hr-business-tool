const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Net Income' }],
  tableOfContents: [
  ...
  formulaDescription: 'Build a profit and loss (income) statement: revenue, COGS, gross profit, operating expenses, net income.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Build a profit and loss (income) statement: revenue, COGS, gross profit, operating expenses, net income.' },
