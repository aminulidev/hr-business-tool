const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Seller Take-Home' }],
  tableOfContents: [
  ...
  formulaDescription: 'Fiverr charges sellers 20% of each order. Buyers pay 5% service fee + $2.50. Calculate your take-home pay.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Fiverr charges sellers 20% of each order. Buyers pay 5% service fee + $2.50. Calculate your take-home pay.' },
