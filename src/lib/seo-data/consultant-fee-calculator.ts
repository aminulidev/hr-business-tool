const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Consultant Fees' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate consultant fees: hourly, daily, project, and retainer. Benchmarks: management $200-500/hr, IT $150-300.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate consultant fees: hourly, daily, project, and retainer. Benchmarks: management $200-500/hr, IT $150-300.' },
