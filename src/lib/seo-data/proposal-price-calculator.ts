const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Proposal Price' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate proposal price for RFPs: labor, materials, subcontractors, overhead, contingency, and profit margin.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate proposal price for RFPs: labor, materials, subcontractors, overhead, contingency, and profit margin.' },
