const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Total Team Cost' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate total project team cost: each member`s hours, rate, and role. See loaded cost with overhead.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate total project team cost: each member`s hours, rate, and role. See loaded cost with overhead.' },
