const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Net Cash Flow' }],
  tableOfContents: [
  ...
  formulaDescription: 'Build a cash flow statement: operating, investing, and financing activities.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Build a cash flow statement: operating, investing, and financing activities.' },
