const seoData = {
  ...
  formulaDescription: 'Track fixed assets: cost, depreciation, book value, and disposal gain/loss.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Track fixed assets: cost, depreciation, book value, and disposal gain/loss.' },
