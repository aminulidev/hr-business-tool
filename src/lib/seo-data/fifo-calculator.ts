const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'FIFO COGS' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate COGS and ending inventory using FIFO (first in, first out) method.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate COGS and ending inventory using FIFO (first in, first out) method.' },
