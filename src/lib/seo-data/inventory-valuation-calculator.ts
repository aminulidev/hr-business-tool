const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Inventory Valuation' }],
  tableOfContents: [
  ...
  formulaDescription: 'Compare inventory valuation methods: FIFO, LIFO, and weighted average cost. See COGS and ending inventory for each.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Compare inventory valuation methods: FIFO, LIFO, and weighted average cost. See COGS and ending inventory for each.' },
