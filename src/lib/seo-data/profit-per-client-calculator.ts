const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Profit Per Client' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate profit per client from monthly revenue, hourly cost of time invested, and direct costs.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate profit per client from monthly revenue, hourly cost of time invested, and direct costs.' },
