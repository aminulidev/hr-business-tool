const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Invoice Total' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate invoice total with line items, subtotal, discount, tax, and final amount due.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate invoice total with line items, subtotal, discount, tax, and final amount due.' },
