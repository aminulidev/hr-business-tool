const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Freelancer Take-Home' }],
  tableOfContents: [
  ...
  formulaDescription: 'Upwork charges 10% flat fee (or sliding scale: 20% first $500, 10% to $10k, 5% above). See take-home pay.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Upwork charges 10% flat fee (or sliding scale: 20% first $500, 10% to $10k, 5% above). See take-home pay.' },
