const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Monthly Revenue' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate monthly revenue from active retainers, hourly work, project milestones, and one-time projects.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate monthly revenue from active retainers, hourly work, project milestones, and one-time projects.' },
