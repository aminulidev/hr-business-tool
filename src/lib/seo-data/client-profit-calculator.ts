const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Client Profit' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate profit per client: client revenue minus direct costs (labor, materials, subcontractors) and overhead.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate profit per client: client revenue minus direct costs (labor, materials, subcontractors) and overhead.' },
