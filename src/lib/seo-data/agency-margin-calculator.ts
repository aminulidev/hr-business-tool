const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Agency Margin' }],
  tableOfContents: [
  ...
  formulaDescription: 'Agency margin = (client billing - contractor cost) / client billing x 100. See margin %, markup %, and profit.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Agency margin = (client billing - contractor cost) / client billing x 100. See margin %, markup %, and profit.' },
