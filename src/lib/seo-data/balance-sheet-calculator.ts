const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Balance Sheet' }],
  tableOfContents: [
  ...
  formulaDescription: 'Build a balance sheet: assets, liabilities, and equity. Verify Assets = Liabilities + Equity.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Build a balance sheet: assets, liabilities, and equity. Verify Assets = Liabilities + Equity.' },
