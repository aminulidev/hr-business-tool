const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Total Manufacturing Cost' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate total manufacturing cost: direct materials + direct labor + manufacturing overhead.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate total manufacturing cost: direct materials + direct labor + manufacturing overhead.' },
