const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Monthly Retainer Fee' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate monthly retainer fee from included hours, hourly rate, retainer discount, and scope of work.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate monthly retainer fee from included hours, hourly rate, retainer discount, and scope of work.' },
