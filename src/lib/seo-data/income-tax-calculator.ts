const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Federal Income Tax' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate federal income tax using 2026 IRS tax brackets and filing status.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate federal income tax using 2026 IRS tax brackets and filing status.' },
