const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Value of Your Time' }],
  tableOfContents: [
  ...
  formulaDescription: 'Calculate the value of your time: annual income / work hours = hourly time value. See cost of any activity.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Calculate the value of your time: annual income / work hours = hourly time value. See cost of any activity.' },
