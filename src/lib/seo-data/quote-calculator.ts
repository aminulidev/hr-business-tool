const seoData = {
  breadcrumbs: [{ label: 'Calculators' }, { label: 'Quote Total' }],
  tableOfContents: [
  ...
  formulaDescription: 'Generate a client quote from labor, materials, subcontractors, overhead, profit margin, and tax.',
  workedExamples: [
    { title: 'Example', description: 'Click Try an Example to see a worked calculation.' },
  ],
  faqs: [
    { question: 'How does this calculator work?', answer: 'Generate a client quote from labor, materials, subcontractors, overhead, profit margin, and tax.' },
