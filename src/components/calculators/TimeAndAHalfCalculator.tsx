...
export default function TimeAndAHalfCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      description="Calculate your overtime pay at 1.5× your regular hourly rate. Instantly see your overtime rate, overtime earnings, and total gross pay."
      icon={<AlarmClock className="h-7 w-7 text-white" />}
