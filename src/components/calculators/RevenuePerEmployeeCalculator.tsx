...
export default function RevenuePerEmployeeCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      description="Calculate your revenue per employee ratio and benchmark it against industry averages. A key productivity metric for measuring workforce efficiency."
