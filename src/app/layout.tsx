...
const websiteJsonLd = {
  ...
  url: SITE_URL,
  description:
    "Free online business and HR calculators — payroll, paycheck, time card, profit margin, ROI, commission, overtime, and more tools for US small business owners.",
  inLanguage: "en-US",
  publisher: {
    "@type": "Organization",
    name: SITE_NAME,
...
const organizationJsonLd = {
  ...
  description: "QuickBizCalc publishes free, ad-supported business and HR calculators for US small business owners, HR professionals, and accountants.",
  foundingDate: "2025",
  sameAs: ["https://twitter.com/QuickBizCalc"],
  contactPoint: [
    { "@type": "ContactPoint", contactType: "customer support", email: CONTACT_EMAIL, availableLanguage: ["English"], url: `${SITE_URL}/contact` },
    { "@type": "ContactPoint", contactType: "privacy", email: CONTACT_EMAIL, availableLanguage: ["English"] },
  ],
};
